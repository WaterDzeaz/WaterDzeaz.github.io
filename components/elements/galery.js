...
export default class GaleryElement {
    ...
    openWindow(html) {
        ...
        const popup = window.open(html, undefined, `width=${width},height=${height},top=${top},left=${left},status=yes,toolbar=no,menubar=no,location=no`);
    }
}
